...
struct SubEmotion: Identifiable, Hashable, Codable {
    ...
    static var emotionSample4: SubEmotion = SubEmotion(name: "vengeful", parent: 0, description: "Wanting or trying to harm someone because they have done something bad to you", icon: "vengeful" )
    static var emotionSample5: SubEmotion = SubEmotion(name: "pleasure", parent: 2, description: "A feeling of happiness, enjoyment, or satisfaction", icon: "pleasure" )
