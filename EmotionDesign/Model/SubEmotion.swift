...
struct SubEmotion: Identifiable, Hashable, Codable {
    ...
    static var emotionSample1: SubEmotion = SubEmotion(name: "panicked", parent: 0, description: "To have a sudden strong feeling of fear or worry and be unable to think clearly or calmly or decide what to do", icon: "panicked" )
    static var emotionSample2: SubEmotion = SubEmotion(name: "stressed", parent: 1, description: "Affected by stress", icon: "stressed" )
    static var emotionSample3: SubEmotion = SubEmotion(name: "scared", parent: 2, description: "Frightened, or worried", icon: "scared" )
    static var emotionSample4: SubEmotion = SubEmotion(name: "vengeful", parent: 3, description: "Wanting or trying to harm someone because they have done something bad to you", icon: "pride" )
    static var emotionSample5: SubEmotion = SubEmotion(name: "pleasure", parent: 4, description: "A feeling of happiness, enjoyment, or satisfaction", icon: "pride" )
